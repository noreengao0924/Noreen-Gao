...
## MATLAB Grader Account Creation
MATLAB Grader Sign-up Page: https://grader.mathworks.com/  

![Sign-up Page](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/Sign%20up%20Page.png)
> Students are required to use the MATLAB Grader for their assignments and quizzes, so please create the MATLAB Grader account.  


![email adress](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/Account1.png).
>This is regeristerd with a goodle email address as an example.
Please make sure that you sign up your accounts using the school emails (userID@uwaterloo.ca).      


![verify email address](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/Account2.png)  

![verify email address 2](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/Account3.png)
>Please Go to your inbox and verify your email address.  


![Personal Info](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/Account4.png)
> Please enter your personal information to finish the registration.


## MATLAB Grader Questions

![HP1](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/HP1.png)
> Under "Courses", you can see the "AE 121" cousres.  


![Question Page1](https://github.com/noreengao0924/Noreen-Gao/blob/MATLAB-GRADER/Question%20Page1.png)  
> After clicking on the course, you can see the question page.   
