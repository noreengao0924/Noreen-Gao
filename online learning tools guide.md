...
The following is a list of online learning tools and technologies that you may
be required to use. Note that due to the extremely short timelines under which
your instructors have had to transition to an online teaching model, they are
each having to choose the set of tools for their courses. This means that you
